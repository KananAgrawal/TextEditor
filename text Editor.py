...
class TextEditor:
    def __init__(self,root):
        ...
        self.status.set("Welcome To My Text Editor Application")
        self.menubar = Menu(self.root,font=("times new roman",15,"bold"),activebackground="skyblue",tearoff=0)
        ...
        self.editmenu = Menu(self.root,font=("times new roman",12,"bold"),activebackground="skyblue",tearoff=0)
    ...
    def openfile(self,*args):
            try:
                self.filename = filedialog.askopenfilename(title="Select File",filetypes=(("ALL Files","*.*"),("Text Files","*.txt"),("Python File","*.py")))
                if self.filename:
    ...
    def saveasfile(self,*args):
            try:
                untitledfile = filedialog.asksaveasfilename(title="Save File As",defaultextension=".txt",initialfile="Untitled.txt",filetypes=(("ALL Files","*.*"),("Text Files","*.txt"),("Python File","*.py")))
                data = self.txtarea.get("1.0",END)
